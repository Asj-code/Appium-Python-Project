...
ele_id = driver.find_element_by_id('com.code2lead.kwad:id/EnterValue').click()
ele_className = driver.find_element_by_class_name('android.widget.EditText').send_keys('andrea')